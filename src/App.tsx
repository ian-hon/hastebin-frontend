...
function App() {
  ...
  return <div className="relative flex no-scrollbar overflow-hidden m-0 p-0 w-full h-full flex-col justify-center items-center bg-background">
    ...
    <div className="overflow-scroll no-scrollbar flex-1 w-full bg-background p-2 sm:p-4">
      <textarea className="w-full h-full text-nowrap text-text text-base sm:text-xl font-mono bg-background outline-none resize-none" autoFocus={true} onKeyDown={keyPressed} spellCheck={false} onChange={(e) => {
