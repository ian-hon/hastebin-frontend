        ...
        <div className="flex flex-wrap gap-3 sm:gap-4 mb-4 items-center">
            ...
            <div className="flex flex-1 items-end justify-end">
                <div
                    ...
                    className="flex items-center gap-2 cursor-pointer select-none duration-300 opacity-50 transform-gpu hover:opacity-100 active:opacity-100"
                >
                    <div className={`w-4 h-4 border-2 rounded transition-colors ${commentsEnabled
                        ? 'bg-accent border-accent'
                        : 'bg-transparent border-text'
                        }`} />
                    <span className="text-text text-sm whitespace-nowrap">comments</span>
                </div>
            </div>
        </div>
        <div className="">
            ...
            <div className="flex flex-col sm:flex-row items-stretch gap-2">
                ...
                <select
                    name="expiryInput"
                    className="input-base flex-1 text-sm text-text appearance-none cursor-pointer"
                    value={expiry}
